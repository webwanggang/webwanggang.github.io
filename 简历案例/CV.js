...
var checkUsername=function(){
    ...
    if(username==""||username==null){
        ...
        //test()方法用来检索字符串是否匹配正则表达式，如果匹配返回true，否则返回flase
...
//这里通过display隐藏、显示，改变月亮的位置，原理是在css中月亮设置了垂直居中样式，垂直居中只有是在inline－block时，才可以使用，这里我在鼠标移出后把display设置为block，所以月亮失去了垂直居中

(function(){

    var oPortrait = document.getElementsByClassName("portrait")[0];
    var aImage = oPortrait.getElementsByTagName("img")[0];
